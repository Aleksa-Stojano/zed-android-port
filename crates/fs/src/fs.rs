...
impl Fs for RealFs {
    ...
    async fn trash(&self, _path: &Path, _options: RemoveOptions) -> Result<TrashId> {
    ...
    #[cfg(target_os = "android")]
    async fn restore(&self, _trash_id: TrashId) -> std::result::Result<PathBuf, TrashRestoreError> {
